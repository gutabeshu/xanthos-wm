...
class HydropowerActual:
    ...
    def __init__(self, HydroDamData, GridData, DrainArea, MissingCap, q_grids):
        """Load inputs, run simulation, and output results."""
        #self.settings = settings
        self.q_grids = q_grids
        self.HydroDamData = HydroDamData
        self.GridData = GridData
        self.DrainArea = DrainArea
        self.MissingCap = MissingCap
        ...
        #self.fname_by_dams = "actual_hydro_by_gcam_reservoir_MWpermth_{}.csv".format(settings.ProjectName)
        #self.OutputFolder = settings.OutputFolder
        self.fname_by_region = "actual_hydro_by_gcam_region_EJperyr.csv"
        self.fname_by_country = "actual_hydro_by_countries_EJperyr.csv"
        self.fname_by_dams = "actual_hydro_by_dam_EJpermth.csv"
        self.OutputFolder = 'D:/Xanthos-Repo/example/input/hydropower_actual'
        #self.filename_hydro = os.path.join('D:/Xanthos-Repo/example/input/hydropower_actual', fname)
