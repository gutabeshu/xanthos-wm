...
class TestCalibManaged(unittest.TestCase):
    ...
    DEFAULT_CONFIG_FILE = pkg_resources.resource_filename('xanthos-wm', 'xanthos/tests/data/inputs/pm_abcd_mrtm_managed.ini')
    EXAMPLE_DIR = pkg_resources.resource_filename('xanthos-wm', 'xanthos/test/data')
    DEFAULT_OUTPUTS_DIR = pkg_resources.resource_filename('xanthos-wm', 'xanthos/test/data/outputs/pm_abcd_mrtm_watch_1971_2001')
